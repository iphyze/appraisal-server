...
try {
    ...
    if ($companyScope !== null && (int) $supervisor['company_id'] !== (int) $companyScope) {
        throw new Exception("Unauthorized: Supervisor does not belong to the selected company context.", 403);
    }
